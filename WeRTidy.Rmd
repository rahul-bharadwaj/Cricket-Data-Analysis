...
```{r PlotBat, warning=FALSE, echo=FALSE, message=FALSE}
#plot-batsman
...
```{r PlotBatBowl, warning=FALSE, echo=FALSE, message=FALSE}
#plot-all-rounder
...
```{r PlotBowl, warning=FALSE, echo=FALSE, message=FALSE}
#plotbowler
...
```{r PlotField, warning=FALSE, echo=FALSE, message=FALSE}
#plot-fielder
...
```{r PlotWK, warning=FALSE, echo=FALSE, message=FALSE}
#plotwk
...
```{r PlotWKBat, warning=FALSE, echo=FALSE, message=FALSE}
#plotwkbat
...
```{r BatsmenPlots, cache=TRUE, warning=FALSE, echo=FALSE, message=FALSE}
#Virat Kohli
...
```{r Grid, fig.height=12, fig.width=8, warning=FALSE, echo=FALSE, message=FALSE}
grid.arrange(ViratKohli, ABdeVilliers, JosButtler, DavidWarner, DavidMiller, ShaneWatson)
```

```{r BowlersPlots, fig.height=10}
